...
public class TierFourConfig implements ConfigData, TierConfig {
    ...
    @Comment("Raid boss level. Default: 50")
    public int boss_level = 50;
    @Comment("Reward Pokemon level. Default: 50")
    public int reward_level = 50;
    ...
    @Comment("How much raid energy is given from a cleared raid. Default: 5")
    public int energy = 5;
