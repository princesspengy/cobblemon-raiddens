...
public abstract class RaidDensMSDCompat {
    ...
    public static ItemStack getMegaStone(ResourceLocation raidBoss) {
        ...
        return switch (path) {
            ...
            case "mega/absol_z" -> MegaShowdownItems.ABSOLITE_Z.get().getDefaultInstance();
            case "mega/barbaracle" -> MegaShowdownItems.BARBARACITE.get().getDefaultInstance();
            case "mega/baxcalibur" -> MegaShowdownItems.BAXCALIBRITE.get().getDefaultInstance();
            ...
            case "mega/garchomp_z" -> MegaShowdownItems.GARCHOMPITE_Z.get().getDefaultInstance();
            case "mega/glimmora" -> MegaShowdownItems.GLIMMORANITE.get().getDefaultInstance();
            case "mega/golisopod" -> MegaShowdownItems.GOLISOPITE.get().getDefaultInstance();
            ...
            case "mega/lucario_z" -> MegaShowdownItems.LUCARIONITE_Z.get().getDefaultInstance();
            ...
            case "mega/raichu_x" -> MegaShowdownItems.RAICHUNITE_X.get().getDefaultInstance();
            case "mega/raichu_y" -> MegaShowdownItems.RAICHUNITE_Y.get().getDefaultInstance();
